...
pgm.add_node("lemons", "Lemons" + r" $(X)$", 1, 1, aspect=3, scale=1.1,
             plot_params={'facecolor': 'yellow', 'edgecolor': 'darkgreen', 'linewidth': 2, 'alpha': 0.8})
pgm.add_node("scurvy", "Scurvy" + r" $(Y)$", 3.25, 1, aspect=3, scale=1.1,
             plot_params={'facecolor': 'thistle', 'edgecolor': 'purple', 'linewidth': 2, 'alpha': 0.8})
pgm.add_edge("lemons", "scurvy")
pgm.render()
plt.title("Simplified Lind's Model of the 1747 Understanding", fontsize=14, pad=20)
```
...
pgm = daft.PGM(dpi=150, alternate_style="outer")
pgm.add_node("acid", "Acid" + r" $(X)$", 1, 3.5, aspect=3, scale=1.1,
             plot_params={'facecolor': 'lightcoral', 'edgecolor': 'darkred', 'linewidth': 2, 'alpha': 0.8})
pgm.add_node("bacteria", "Bacteria" + r" $(Y)$", 3.25, 2.5, aspect=3, scale=1.1,
             plot_params={'facecolor': 'skyblue', 'edgecolor': 'blue', 'linewidth': 2, 'alpha': 0.8})
pgm.add_node("scurvy", "Scurvy" + r" $(Z)$", 5.5, 1.5, aspect=3, scale=1.1,
             plot_params={'facecolor': 'thistle', 'edgecolor': 'purple', 'linewidth': 2, 'alpha': 0.8})
pgm.add_edge("acid", "bacteria")
pgm.add_edge("bacteria", "scurvy")
pgm.render()
plt.title("Misguided Belief: Acid Causes Scurvy", fontsize=14, pad=20)
```
...
pgm = daft.PGM(dpi=150, alternate_style="outer")
pgm.add_node("vitamin_c", "Vitamin C" + r" $(X)$", 1, 4, aspect=3, scale=1.1,
             plot_params={'facecolor': 'lightgreen', 'edgecolor': 'darkgreen', 'linewidth': 2, 'alpha': 0.8})
pgm.add_node("collagen", "Collagen" + r" $(Y)$", 3.25, 3, aspect=3, scale=1.1,
             plot_params={'facecolor': 'lightblue', 'edgecolor': 'blue', 'linewidth': 2, 'alpha': 0.8})
pgm.add_node("scurvy", "Scurvy" + r" $(Z)$", 5.5, 2, aspect=3, scale=1.1,
             plot_params={'facecolor': 'thistle', 'edgecolor': 'purple', 'linewidth': 2, 'alpha': 0.8})
pgm.add_edge("vitamin_c", "collagen")             
pgm.add_edge("collagen", "scurvy")
pgm.render()
plt.title("1928 Understanding: Vitamin C Prevents Scurvy", fontsize=14, pad=20)
```
